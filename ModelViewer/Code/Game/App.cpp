...
{
	g_materials[BRICK] = new Material();
	g_materials[BRICK]->Load("Data/Materials/Brick.xml");	
	
	g_materials[GRASS] = new Material();
	g_materials[GRASS]->Load("Data/Materials/Grass.xml");
}
